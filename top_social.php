	    ...
	    <div id="body_r">
	    	<div class="title_area">
	    		<div class="article_detail_path">
	                <ul>
	                    ...
	                    <li><a href="social.php">灯具</a></li>
	                    <li><a href="top_social.php" class="location">灯具排行</a></li>
	                </ul>
	            </div>
	        </div>
	        <div class="top_header">
	        	<ul>
	            	<li class="selected">灯具</li>
	        ...
	        <div class="top_body">
	        	...
	        	<ul id="hiddenresult" style="display:none">
					<?
						$_i = 0;
	                    $rs_top = _query("SELECT * FROM bamboo WHERE type=1 && check_bamboo=1 ORDER BY score DESC");
