...
$(function(){
	$(".main_nav .sidelist").hover(function(){
		...
		if(nav_index == 0){
			...
			$(".nav_title").css("background","#665e49");
			$(".sidebar").css("border-color","#665e49");
			$("#screen").css("background","#665e49");
			$("#screen").css("border-color","#665e49");
			$(".content_title").css("background","#665e49");
		} else if(nav_index == 1){
			$(this).animate({
		...
		$("#screen").css("background","#a42c6a");
		$("#screen").css("border-color","#a42c6a");
		$(".content_title").css("background","#a42c6a");
	})
})