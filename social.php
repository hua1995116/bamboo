...
<head>
	...
	?>
	<link rel="stylesheet" href="styles/social.css" type="text/css" />
	    ...
	    <div id="body_r">
	    	...
	    	<div class="focus">
    			<div id="screen" class="wrap clear">
    				<div class="bd">
    					<?
    						$rs_focus = _query("SELECT * FROM bamboo WHERE type=1 && check_bamboo=1 ORDER BY time DESC LIMIT 6");
    				...
    				<div class="hd">
    					<ul>
    						<?
    							$rs_focus_hd = _query("SELECT * FROM bamboo WHERE type=1 && check_bamboo=1 ORDER BY time DESC LIMIT 6");
	        ...
	        <div id="article_list">
				<?
	            $rs_fall = _query("SELECT * FROM bamboo WHERE type=1 && check_bamboo=1 ORDER BY modify_time DESC LIMIT 3");
