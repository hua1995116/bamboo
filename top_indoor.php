	    ...
	    <div id="body_r">
	    	<div class="title_area">
	    		<div class="article_detail_path">
	                <ul>
	                    ...
	                    <li><a href="indoor.php">日常用品</a></li>
	                    <li><a href="top_indoor.php" class="location">日常用品排行</a></li>
	                </ul>
	            </div>
	        </div>
	        ...
	        <div class="top_body">
	        	...
	        	<ul id="hiddenresult" style="display:none">
					<?
						$_i = 0;
	                    $rs_top = _query("SELECT * FROM bamboo WHERE type=4 && check_bamboo=1 ORDER BY score DESC");
