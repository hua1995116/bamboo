...
(function () {
	...
	window.UEDITOR_HOME_URL = getRootPath()+"/ueditor/";
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,imagePath:"ueditor/php/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ...
        , toolbars:[["bold","italic","underline","forecolor","backcolor","superscript","subscript","justifyleft","justifycenter","justifyright","justifyjustify","touppercase","tolowercase","indent","removeformat","formatmatch","paragraph","rowspacingbottom","rowspacingtop","lineheight"],["fontfamily","fontsize","imagenone","imageleft","imageright","imagecenter","insertimage","emotion","insertvideo","blockquote","highlightcode","template","background","undo","redo","unlink","link","cleardoc","selectall","searchreplace"]]
