...
<head>
	...
	?>
	<link rel="stylesheet" href="styles/indoor.css" type="text/css" />
	<script src="scripts/slider.js" type="text/javascript"></script>
	<script src="scripts/common.js" type="text/javascript"></script>
	<script type="text/javascript" src="scripts/waterfall.js"></script>
	<script type="text/javascript" src="scripts/indoor.js"></script>
	    ...
	    <div id="body_r">
	    	...
	    	<div class="focus">
    			<div id="screen" class="wrap clear">
				  	<div class="bd">
				    	<?
    						$rs_focus = _query("SELECT * FROM bamboo WHERE type=4 && check_bamboo=1 ORDER BY time DESC LIMIT 6");
				  	...
				  	<div class="hd">
				    	<ul>
						    <?
    							$rs_focus_hd = _query("SELECT * FROM bamboo WHERE type=4 && check_bamboo=1 ORDER BY time DESC LIMIT 6");
	    	...
	    	<div class="content_title1">
	        	<p>日常用品</p>
	        	<a href="top_indoor.php">查看完整排行</a>
	        </div>
	    	<!--瀑布流-->
	        <!--此处必须使用id-->
	        <div id="article_list">
				<?
	            $rs_fall = _query("SELECT * FROM bamboo WHERE type=4 && check_bamboo=1 ORDER BY modify_time DESC LIMIT 3");
	            while ($rows_fall = _fetch_array_list($rs_fall)){
	                ...
	                echo '
	                    <div class="pin">
	                        <div class="box">
	                            <ef="bamboo_deta hrail.php?id='.$data_fall['id'].'">'.$data_fall['img'].'</a>
	                            <div class="note_area">
