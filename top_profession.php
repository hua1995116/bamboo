	    ...
	    <div id="body_r">
	    	<div class="title_area">
	    		<div class="article_detail_path">
	                <ul>
	                    ...
	                    <li><a href="profession.php">装饰用品</a></li>
	                    <li><a href="top_profession.php" class="location">装饰用品排行</a></li>
	                </ul>
	            </div>
	        </div>
	        <div class="top_header">
	        	<ul>
	                ...
	                <li><a href="top_daily.php">家具用品</a></li>
	                <li class="selected">装饰用品</li>
	        ...
	        <div class="top_body">
	        	...
	        	<ul id="hiddenresult" style="display:none">
					<?
						$_i = 0;
	                    $rs_top = _query("SELECT * FROM bamboo WHERE type=3 && check_bamboo=1 ORDER BY score DESC");
