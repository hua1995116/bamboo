	    ...
	    <div id="body_r">
	    	<div class="title_area">
	    		<div class="article_detail_path">
	                <ul>
	                    ...
	                    <li><a href="child.php">其他</a></li>
	                    <li><a href="top_child.php" class="location">其他排行</a></li>
	                </ul>
	            </div>
	        </div>
	        ...
	        <div class="top_body">
	        	...
	        	<ul id="hiddenresult" style="display:none">
					<?
						$_i = 0;
	                    $rs_top = _query("SELECT * FROM bamboo WHERE type=5 && check_bamboo=1 ORDER BY score DESC");
